...
public class GrievanceController {
    ...
    @PutMapping("/{id}/mark-step")
    public ResponseEntity<Grievance> markStepCompletedByUser(
            @PathVariable String id,
            @RequestParam String step) {
        return ResponseEntity.ok(grievanceService.markStepCompletedByUser(id, step));
    }
